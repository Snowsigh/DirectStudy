...
void KWindow::CenterWindow(HWND hwnd)
{
...
bool KWindow::InitWindow(HINSTANCE hInstance, int nCmdShow, const TCHAR* strWindowTitle)
{
    // Register class
    WNDCLASSEX wcex;
    ...
    m_hWnd = CreateWindowEx(WS_EX_TOOLWINDOW, //WS_EX_TOPMOST,// | WS_EX_TOOLWINDOW,
        L"KKO_PROJECT", strWindowTitle, WS_OVERLAPPEDWINDOW,
